                  ...
                  <body class="bg-light">
                    ...
                    <div class="container py-5 animate-fade-in">
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="fw-bold text-primary"><i class="fas fa-boxes me-2"></i>Gestion des Produits</h1>
                        <button class="btn btn-primary-custom text-white rounded-pill px-4 shadow-sm" type="button"
                                    ...
                                    <form action="/admin/products" method="post" class="row g-3">
                                      ...
                                      <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                          <input type="number" step="0.01" class="form-control bg-light" name="price"
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-text small"><i class="fas fa-info-circle me-1"></i>L'image sera
                                          téléchargée sur le serveur.</div>
                                      </div>

                                      <div class="col-12 text-end">
                                        <button type="button" class="btn btn-light rounded-pill px-4 me-2"
                                          data-bs-toggle="collapse" data-bs-target="#addProductForm">Annuler</button>
                                        <button type="submit"
                                  ...
                                  <div class="row g-2 align-items-center">
                                    <div class="col-md-4">
                                      <div class="input-group">
                                        ...
                                        <input type="text" id="searchName" class="form-control border-start-0 ps-0"
                                    ...
                                    <div class="col-md-3">
                                      <input type="number" id="filterMaxPrice" class="form-control border-0 bg-light"
                                        placeholder="Prix max (€)">
                                    </div>
                                    <div class="col-md-2">
                                      <button class="btn btn-secondary w-100 rounded-pill" onclick="resetFilters()">
                              ...
                              <% if (products !=null && !products.isEmpty()) { %>
                                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4"
                                  ...
                                  <% for (Product p : products) { String safeName=(p.getName() !=null) ?
                                    p.getName().replace("\"", "&quot;" ) : "" ; String safeDesc=(p.getDescription()
                                    !=null) ? p.getDescription().replace("\"", "&quot;" ) : "" ; String
                                    ...
                                    <div class="col product-item animate-fade-in"
                                      ...
                                      <div class="card h-100 product-card border-0 shadow-sm rounded-4 overflow-hidden">
                                            ...
                                            <% } else { %>
                                              ...
                                              <% } %>
                                                ...
                                                <div class="action-overlay">
                                                  <form action="/admin/products" method="post" class="d-inline">
                                        ...
                                        <div class="card-body p-3 d-flex flex-column">
                                          <div class="mb-2">
                                            <span class="badge bg-light text-primary border rounded-pill small mb-1">
                                              <%= p.getCategory() %>
                                            </span>
                                          </div>
                                          ...
                                          <div
                                            ...
                                            <button class="btn btn-sm btn-outline-primary rounded-pill px-3 edit-btn"
                                              ...
                                              data-category-id="<%= p.getCategoryId() %>" data-name="<%= safeName %>"
                                              data-price="<%= safePrice %>" data-description="<%= safeDesc %>"
                                ...
                                <% } else { %>
                                  <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">Utilisez le bouton "Nouveau Produit" pour commencer.</p>
                                  </div>
                                  <% } %>
                    </div>
